...
public:
    string minWindow(string s, string t) {
        ...
        for (; end < s.size(); ++end) {
            ...
            // If we now have less than or equal to t's count, then we matched one more character
            // So, increment chars_matched.
            window_freq[s[end]]++;
            ...
            while (chars_matched >= t.size() && start <= end) {
                ...
                // If after decreasing this character's count in the window, it has fewer than t
